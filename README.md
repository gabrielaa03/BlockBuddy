...
The app uses three fragments. For switching between them, the app uses a Navigation Component and Navigation Graph. I wanted to try this out for some time now, so I decided to go with Bottom Navigation Bar. 
